...
2. Просит явное подтверждение перед установкой системных Intel OpenCL/Level Zero драйверов.
...
4. Проверяет, что устройство `GPU` действительно доступно OpenVINO.
